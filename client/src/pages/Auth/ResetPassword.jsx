...
export default function ResetPassword() {
	...
	return (
		<Layout>
			<Heading textAlign='center' my={12}>Reset password</Heading>
				...
				>
					<Stack spacing='6'>
						<FormControl id='password'>
							...
							<Input type='password' autoComplete='password' required value={password} onChange={e => setPassword(e.target.value)} />
						</FormControl>
