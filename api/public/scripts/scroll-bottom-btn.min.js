...
function addScrollBottomBtn() {
	var o,
		...
		p =
			void 0 === u
				...
				: u,
		m = i.id,
		h = void 0 === m ? 'scroll-bottom-btn' : m,
		b = i.innerHTML,
		v =
			void 0 === b
				? '<svg viewBox="0 0 24 24"><g transform="translate(0,24) scale(1,-1)"><path d="M7.41 15.41L12 10.83l4.59 4.58L18 14l-6-6-6 6z"/></g></svg>'
				: b,
		f = i.onClickScrollTo,
		x = void 0 === f ? 0 : f,
		w = i.scrollContainer,
		...
		M = void 0 === T ? 1 : T,
		F = document.body.scrollHeight - window.innerHeight,
		z = i.size,
		E = void 0 === z ? l : z,
		C = i.textColor,
		L = void 0 === C ? '#fff' : C,
	...
	function q(o) {
		(g.scrollTop = F), B && (document.documentElement.scrollTop = F);
	}
